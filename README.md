...
The `DCOILWTICO` column represents dollars per barrel at the time of the corresponding `DATE`.  
...
## Contact Details
- If you find any issues with or have enhancement ideas for this product, open up a GitHub [issue](https://github.com/rearc-data/fred-crude-oil-prices/issues) and we will gladly take a look at it. Better yet, submit a pull request. Any contributions you make are greatly appreciated :heart:.
